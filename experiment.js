...
timeline.push({
  type: jsPsychHtmlKeyboardResponse,
  stimulus: `<div>
  <h2> Please prepare for the test as shown below </h2> <h3> Press any key to continue </h3> <img src= "img/Single Implicit Motivation Image.png" style = "width:500px; height: auto;"/>
  </div>`,
  save_trial_parameters: {
    simulus: false
  },
